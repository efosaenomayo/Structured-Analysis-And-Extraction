...
def batch(pdf_dir, output_dir, method, lang):
    ...
    datasets = batch_build_dataset(doc_paths, 8, lang)
...
if __name__ == '__main__':
    ...
    DigFolds = os.path.join(DocFolds, 'Digits')
    out_path = os.path.join(DocFolds, "Mine_output")
    #pdf_path = os.path.join(DocFolds, '6H-SiC JFETs for 450 °C Differential Sensing Applications.pdf')
    batch(DigFolds, out_path, "auto", "en")
